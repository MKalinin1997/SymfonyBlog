...
class AppFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setImage('first_picture.jpg');
        ...
        $blog2->setImage('second_picture.jpg');
        ...
        $blog3->setImage('third_picture.jpg');
        ...
        $blog4->setImage('fourth_picture.jpg');
        ...
        $blog5->setImage('fifth_picture.jpg');
